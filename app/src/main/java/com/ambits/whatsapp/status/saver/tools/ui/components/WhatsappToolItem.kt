...
@Composable
fun WhatsappToolItem(
    whatsappToolsEnum: WhatsappToolsEnum,
    onItemClick: (WhatsappToolsEnum) -> Unit
) {
    Card(
        onClick = { onItemClick(whatsappToolsEnum) }, modifier = Modifier
            .fillMaxWidth()
            .height(150.dp)
    ) {
        Column(
